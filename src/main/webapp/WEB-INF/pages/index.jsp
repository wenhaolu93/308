                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="wp-block inverse">
                                <div class="figure">
                                    <img alt="" src="<c:url value="/resources/images/prv/team/team-corporate-5.jpg"/>" class="img-responsive">
                                ...
                                <h2>Wenhao Lu<small>Data Designer</small></h2>
                                <p>
                        ...
                        <div class="col-md-3">
                            <div class="wp-block inverse">
                                <div class="figure">
                                    <img alt="" src="<c:url value="/resources/images/prv/team/team-corporate-3.jpg"/>" class="img-responsive">
                                    <div class="figcaption">
                                        <ul class="social-icons text-right">
                                            <li class="text pull-left">More on:</li>
                                            <li class="facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                                ...
                                <h2>Shan Liu<small>Project Manager</small></h2>
                                <p>
                        ...
                        <div class="col-md-3">
                            <div class="wp-block inverse">
                                <div class="figure">
                                    <img alt="" src="<c:url value="/resources/images/prv/team/team-corporate-1.jpg"/>" class="img-responsive">
                                    <div class="figcaption">
                                        <ul class="social-icons text-right">
                                            <li class="text pull-left">More on:</li>
                                            <li class="facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="col-md-3">
                            <div class="wp-block inverse">
                                <div class="figure">
                                    <img alt="" src="<c:url value="/resources/images/prv/team/team-corporate-2.jpg"/>" class="img-responsive">
                                    <div class="figcaption">
                                        <ul class="social-icons text-right">
                                            <li class="text pull-left">More on:</li>
                                            <li class="facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
